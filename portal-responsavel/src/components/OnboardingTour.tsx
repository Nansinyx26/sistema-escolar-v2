...
const OnboardingTour: React.FC<Props> = ({ steps, onComplete, onSkip }) => {
  ...
  return (
    <>
      {/* biome-ignore lint/a11y/noStaticElementInteractions lint/a11y/useKeyWithClickEvents: fundo do tour; o teclado fecha pelo botão Pular */}
      <div
        style={{
          position: 'fixed',
          inset: 0,
      ...
      <div style={getPopupStyle()}>
        ...
        <div style={{ display: 'flex', gap: '0.75rem', justifyContent: 'flex-end' }}>
          ...
          <button type="button" onClick={skip} style={btnSecondary} disabled={saving}>
            Pular
          </button>
          {isLast ? (
            <button type="button" onClick={finish} style={btnPrimary} disabled={saving}>
...
export const RESPONSAVEL_TOUR_STEPS: TourStep[] = [
  {
    ...
    content:
      'Este é o portal do responsável. Aqui você acompanha notas, frequência e comunicados da escola. O tour possui 7 etapas.',
  },
  {
    target: '[data-tour="sidebar"]',
    title: 'Menu de Navegação',
    content:
      'Use o menu lateral para navegar entre as seções: painel, perfil, notificações e configurações.',
  },
  {
    target: '[data-tour="summary-cards"]',
    title: 'Cards de Resumo',
    content: 'Visualize rapidamente a média geral, frequência e notificações pendentes do aluno.',
  },
  {
    target: '[data-tour="notes"]',
    title: 'Notas por Matéria',
    content: 'Acompanhe o desempenho em cada disciplina com barras de progresso visuais.',
  },
  {
    target: '[data-tour="notifications"]',
    title: 'Notificações',
    content: 'O sino indica comunicados da escola. O indicador verde mostra novidades não lidas.',
  },
  {
    target: '[data-tour="profile"]',
    title: 'Perfil e Dados',
    content: 'Atualize telefone, WhatsApp, e-mail e dados pessoais no menu de perfil.',
  },
