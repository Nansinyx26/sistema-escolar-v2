...
const getPasswordStrength = (pwd: string) => {
  ...
  switch (score) {
    case 0:
    case 1:
      return { width: '25%', color: '#ef4444', text: 'Fraca' };
    case 2:
      return { width: '50%', color: '#f59e0b', text: 'Média' };
    case 3:
      return { width: '75%', color: '#3b82f6', text: 'Boa' };
    case 4:
      return { width: '100%', color: '#10b981', text: 'Forte' };
    default:
      return { width: '0%', color: '#ef4444', text: '' };
  }
};
...
/**
 * Foca o campo assim que ele entra em tela — o primeiro de cada etapa do fluxo
 * de recuperacao de senha.
 *
 * Faz o mesmo que o atributo `autoFocus`, mas via callback ref. O atributo e
 * aplicado pelo navegador no parse do documento, momento em que um leitor de
 * tela ainda pode estar anunciando outra coisa; no mount do elemento o foco
 * acompanha a troca de etapa, que e o que a pessoa espera.
 */
...
const PortalResponsavel: React.FC = () => {
  ...
  // Escape fecha o modal de recuperacao de senha. O clique no fundo ja fechava;
  // quem navega por teclado ficava sem saida.
  useEffect(() => {
          ...
          {isRegistering ? (
            <form onSubmit={handleRegister} className={styles.loginForm} noValidate>
              <div className={styles.formGroup}>
                <label className={styles.formLabel} htmlFor="campo-nome-completo">
                  Nome Completo
                </label>
              ...
              <div className={styles.formGroup}>
                <label className={styles.formLabel} htmlFor="campo-e-mail">
                  E-mail
                </label>
                <div className={styles.inputWrapper}>
              ...
              <div className={styles.formGroup}>
                ...
                <div className={styles.inputWrapper}>
                  ...
                  >
                    <i
                      className={`ti ${showRegisterPassword ? 'ti-eye-off' : 'ti-eye'}`}
                      aria-hidden="true"
                    />
                  </button>
                </div>
            ...
            <>
              ...
              {showForgotModal && (
                /* Fundo do modal, fechavel por clique e por Escape (efeito acima). */
                ...
                <div
                  ...
                  role="presentation"
                  onClick={(e) => {
                    // So o proprio fundo fecha; dispensa o stopPropagation que
                    // o cartao precisava para nao se fechar sozinho.
                    ...
                    >
                      ...
                      >
                        <div
                          style={{
                            ...
                            height: '8px',
                            borderRadius: '50%',
                            background: forgotStep >= 1 ? '#10b981' : 'rgba(255,255,255,0.1)',
                          }}
                        />
                        <div
                          style={{
                            ...
                            height: '8px',
                            borderRadius: '50%',
                            background: forgotStep >= 2 ? '#10b981' : 'rgba(255,255,255,0.1)',
                          }}
                        />
                        <div
                          style={{
                            ...
                            height: '8px',
                            borderRadius: '50%',
                            background: forgotStep >= 3 ? '#10b981' : 'rgba(255,255,255,0.1)',
                          }}
                        />
                      </div>
                      {forgotStep === 1 && (
                        <div className={styles.loginForm}>
                          ...
                          >
                            Informe seu e-mail cadastrado. Enviaremos um código de 6 dígitos para
                            redefinir sua senha.
                          </p>
                          <div className={styles.formGroup} style={{ marginBottom: '24px' }}>
                            <label className={styles.formLabel} htmlFor="campo-e-mail-2">
                              E-mail
                            </label>
                            <div className={styles.inputWrapper}>
                              <Icon name="mail" aria-hidden="true" />
                      ...
                      {forgotStep === 2 && (
                        <div className={styles.loginForm}>
                          ...
                          >
                            Enviamos um código de recuperação para <strong>{forgotEmail}</strong>.
                            Insira-o abaixo.
                          </p>
                          <div
                          ...
                          >
                            <label
                              ...
                              htmlFor="campo-codigo-6-digitos"
                            >
                              Código de 6 dígitos
                            </label>
                            <input
                          ...
                          >
                            <p style={{ color: '#64748b', margin: '0 0 8px 0' }}>
                              <Icon name="clock" /> Código válido por{' '}
                            ...
                            <div>
                              ...
                              <button
                                ...
                                style={{
                                  background: 'none',
                                  border: 'none',
                                  color: resendCountdown > 0 ? '#64748b' : '#10b981',
                      ...
                      {forgotStep === 3 && (
                        <div className={styles.loginForm}>
                          ...
                          <div className={styles.formGroup} style={{ marginBottom: '16px' }}>
                            <label className={styles.formLabel} htmlFor="campo-nova-senha">
                              Nova Senha
                            </label>
                            <div className={styles.inputWrapper}>
                              <Icon name="lock" aria-hidden="true" />
                              ...
                              >
                                <i
                                  className={`ti ${showNewPassword ? 'ti-eye-off' : 'ti-eye'}`}
                                  aria-hidden="true"
                                />
                              </button>
                            </div>
                          ...
                          >
                            ...
                            <ul style={{ margin: 0, paddingLeft: '16px', listStyleType: 'disc' }}>
                              <li
                                style={{
                                  color: forgotNewPassword.length >= 8 ? '#10b981' : '#94a3b8',
                                }}
                              >
                                Mínimo 8 caracteres
                              </li>
                              <li
                                style={{
                                  color: /[A-Z]/.test(forgotNewPassword) ? '#10b981' : '#94a3b8',
                                }}
                              >
                              ...
                              <li
                                style={{
                                  color: /[0-9]/.test(forgotNewPassword) ? '#10b981' : '#94a3b8',
                                }}
                              >
                                Pelo menos 1 número
                              </li>
                          ...
                          <div className={styles.formGroup} style={{ marginBottom: '24px' }}>
                            <label className={styles.formLabel} htmlFor="campo-confirmar-senha">
                              Confirmar Senha
                            </label>
                            <div className={styles.inputWrapper}>
                              <Icon name="lock" aria-hidden="true" />
              ...
              <div className={styles.registerSection}>
                ...
                <button
                  ...
                  onClick={() => {
                    try {
                      sessionStorage.setItem('primeiroAcessoTipo', 'responsavel');
                    } catch {
                      // sessionStorage bloqueado (aba anonima, cookies off): a
                      // pagina de primeiro acesso lida com a chave ausente.
                    }
