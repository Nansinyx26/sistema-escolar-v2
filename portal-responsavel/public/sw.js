const CACHE_NAME = 'escola-jaguari-v2-' + new Date().getTime(); // Cache dinâmico para forçar atualização
...
self.addEventListener('fetch', (event) => {
  ...
  // Estratégia Network First para documentos (HTML) para garantir versão nova
