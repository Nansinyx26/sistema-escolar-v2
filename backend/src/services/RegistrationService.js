...
class RegistrationService {
    ...
    static async registerResponsavel(data) {
        try {
            ...
            if (!RegistrationService.validatePasswordStrength(senha)) {
                return {
                    success: false,
            ...
            if (aluno.responsavel && RegistrationService.validateEmail(aluno.responsavel)) {
                return {
                    success: false,
            ...
            // Gerar JWT
            const token = RegistrationService._generateJWT(user);
    ...
    static async registerDocente(data) {
        try {
            ...
            await Professor.create({
                ...
                vinculos: user.escolaId
                    ? [{ escolaId: String(user.escolaId), cargo: 'professor' }]
                    : [],
            });
