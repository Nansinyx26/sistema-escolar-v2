...
const ComunicadoSchema = new mongoose.Schema({
    ...
    categoria: {
        type: String,
        default: 'Direção',
        enum: ['Todos', 'Direção', 'Secretaria', 'Professores', 'Responsáveis', 'Sistema'],
    },
...
ComunicadoSchema.index({ escolaId: 1, ativo: 1, dataCriacao: -1 });
ComunicadoSchema.index({ ativo: 1, dataCriacao: -1 });
