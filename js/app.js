...
class App {
    ...
    async updateUserNavbar() {
        ...
        // Sincroniza dados com o servidor para garantir foto atualizada
        ...
        // Executa atualização global de fotos
    ...
    setupTurmaEvents(turmaId, bimestre) {
        ...
        document.getElementById('btnVoltar')?.addEventListener('click', () => {
            if (typeof window.smartBack === 'function') window.smartBack('selecionar.html');
