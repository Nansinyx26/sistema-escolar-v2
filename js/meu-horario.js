...
const NOMES_PROF = {
    ...
    'SANDRA': 'Sandra', 'TAYRINE': 'Tayrine', 'DENISE': 'Denise',
    'ADRIANA': 'Adriana', 'SIRLEI': 'Sirlei', 'IVANI': 'Ivani',
    'JUSSARA': 'Jussara', 'MEIRE SOUZA': 'Meire Souza', 'EDITE': 'Edite', 'MARIANGELA': 'Mariangela',
    'PATRICIA': 'Patricia', 'LUCIANA': 'Luciana', 'NILCEIA': 'Nilcéia', 'FABIANA': 'Fabiana',
    'FATIMA': 'Fátima', 'LOURDES': 'Lourdes', 'FLAVIA': 'Flavia'
};
...
const DISC_PROF = {
    ...
    'SANDRA': 'PEB 1 (Turma 3ºA)', 'TAYRINE': 'PEB 1 (Turma 3ºB)', 'DENISE': 'PEB 1 (Turma 3ºC)',
    'ADRIANA': 'PEB 1 (Turma 5ºB)', 'SIRLEI': 'PEB 1 (Turma 4ºB)', 'IVANI': 'PEB 1 (Turma 4ºC)',
    'JUSSARA': 'PEB 1 (Turma 5ºA)', 'MEIRE SOUZA': 'PEB 1 (Turma 5ºB)', 'EDITE': 'PEB 1 (Turma 5ºC)', 'MARIANGELA': 'PEB 1 (Turma 5ºD)',
    'PATRICIA': 'PEB 1 (Turma 4ºA)', 'LUCIANA': 'PEB 1 (Turma 4ºB)', 'NILCEIA': 'PEB 1 (Turma 4ºC)',
    'FABIANA': 'PEB 1 (Turma 5ºA)', 'FATIMA': 'PEB 1 (Turma 5ºC)', 'LOURDES': 'PEB 1 (P.A.)', 'FLAVIA': 'PEB 1 (Turma 5ºD)'
};

const PROF_PARA_SALA = {
    'LEONORA': '1A', 'CLEUSA': '1B', 'GISLEIDE': '1C',
    'MEIRE BRAZ': '2A', 'MEIRE CANALI': '2B', 'CLEIDE': '2C',
    'SANDRA': '3A', 'TAYRINE': '3B', 'DENISE': '3C',
    'ADRIANA': '5B', 'SIRLEI': '4B', 'IVANI': '4C',
    'JUSSARA': '5A', 'MEIRE SOUZA': '5B', 'EDITE': '5C', 'MARIANGELA': '5D',
    'PATRICIA': '4A', 'LUCIANA': '4B', 'NILCEIA': '4C', 'FABIANA': '5A',
    'FATIMA': '5C', 'LOURDES': 'VARIADOS', 'FLAVIA': '5D'
};
