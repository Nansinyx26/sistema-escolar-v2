...
let cfg = {
    voice: localStorage.getItem('user_voice_preference') || 'male',
    lang: 'pt-BR',
    provider: localStorage.getItem('user_tts_provider') || 'auto'
};
...
async function iniciar() {
    ...
    // Clicar no orb narra a última resposta (a captação por microfone segue
    // desativada por política — o comportamento é o mesmo da versão anterior).
