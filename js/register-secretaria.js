/**
 * Register Secretaria — Cadastro Público de Secretaria
 * Valida código secreto, força de senha e envia para /api/auth/register-secretaria
 */

document.addEventListener('DOMContentLoaded', () => {
    const form = document.getElementById('secretariaRegisterForm');
    ...
    form.addEventListener('submit', async (e) => {
        ...
        try {
            ...
            showToast('Conta de secretaria criada com sucesso! Redirecionando...', 'success');
